...
final class PeripheralConnectionManager {
    ...
    private func discoverServicesAndCharacteristics(peripheral: Peripheral) async throws {
        ...
        // Commenting this out removes the state missmatch of isNotifying in the heartRateMeasurementCharacteristic.
        let heartRateControlCharacteristic = try await peripheral.discoverCharacteristic(BLEIdentifiers.Characteristic.heartRateControl, for: heartRateService)
